	...
	return (
		<div className={`modal ${state ? "modal--show" : ""}`}>
			<div className="modal-header">
				<h3 className="modal-caption">Форма регистрации</h3>
				<button className="modal-close" onClick={clickHandler}>
				<svg fill="#9f8585" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 94.926 94.926"	>
